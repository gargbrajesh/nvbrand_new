          ...
          <Grid container className={styles.footerInnerContainer2}>
            <div className={styles.footer_list}>
              <ul>
                ...
                <li>
                  <Link href="/Privacy">
                    <Image className="socialicon" alt="Logo" src={footerIcon1} />
                  </Link>
                </li>
                <li>
                  <Link href="/Cookies">
                    <Image className="socialicon"  alt="Logo"src={footerIcon2} />
                  </Link>
                </li>
                <li>
                  <Link href="/terms-condition">
                    <Image className="socialicon" alt="Logo" src={footerIcon3} />
                  </Link>
                </li>
                <li>
                  <Link href="/AboutUs">
                    <Image className="socialicon" alt="Logo" src={footerIcon4} />
                  </Link>
                </li>
          ...
          <div style={{ justifyContent: 'center', alignItems: 'center', marginTop: '-1%', marginBottom: '10px' }}>
            <header className={styles.header}>
              {/* <a href="https://www.facebook.com/groups/411171767491908/?ref=share" target="new" title="Soundcloud">
                <img class="socialicon" src={faceBookIcon} alt="Logo" height="30" width="30" /> </a>
              <a href="" target="new" title="Soundcloud">
                <img class="socialicon" src={twitter} alt="Logo" height="30" width="30" /> </a>
              <a href="" target="new" title="Soundcloud">
                <img class="socialicon" src={instagram} alt="Logo" height="30" width="30" /> </a>
              <a href="https://www.instagram.com/invites/contact/?i=1ficawmftjf7o&utm_content=n9z355c" target="new" title="Soundcloud">
                <img class="socialicon" src={youtube} alt="Logo" height="30"  width="30" /> </a>
              <a href="" target="new" title="Soundcloud">
                <img class="socialicon" src={LinkedIn} alt="Logo" height="30" width="30" /> </a> */}
            </header>
