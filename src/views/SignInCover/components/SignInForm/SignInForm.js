        ...
        <Paper elevation={10} style={paperStyle} >
          <div>
            ...
            >
              ...
              <div style={{ padding: '0px 20px' }}><TextField id="standard-basic" label="Enter your Email?" variant="standard" style={{ width: '95%' }} /></div>
              <div style={{ padding: '0px 20px' }}><TextField id="standard-basic" label="Enter you password" variant="standard" style={{ width: '95%' }} /></div>
