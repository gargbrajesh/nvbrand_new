          ...
          <Grid container className={styles.footerInnerContainer2}>
            <div className={styles.footer_list}>
              <ul>
                ...
                <li>
                  <Link href="/Privacy">
                    <Image className="socialicon" src={footerIcon1} />
                  </Link>
                </li>
                <li>
                  <Link href="/Cookies">
                    <Image className="socialicon" src={footerIcon2} />
                  </Link>
                </li>
                <li>
                  <Link href="/terms-condition">
                    <Image className="socialicon" src={footerIcon3} />
                  </Link>
                </li>
                <li>
                  <Link href="/AboutUs">
                    <Image className="socialicon" src={footerIcon4} />
                  </Link>
                </li>
